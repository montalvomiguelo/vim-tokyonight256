...
" Last Updated: Sat  7 Oct 21:07:46 2023
...
hi clear
let g:colors_name = 'tokyonight256_quiet'
...
hi Directory guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
...
hi Folded guifg=#636da6 guibg=#222436 gui=NONE cterm=NONE
...
hi MoreMsg guifg=#828bb8 guibg=NONE gui=NONE cterm=NONE
...
hi Question guifg=#828bb8 guibg=NONE gui=NONE cterm=NONE
...
hi WarningMsg guifg=#828bb8 guibg=NONE gui=NONE cterm=NONE
hi WildMenu guifg=#ffc777 guibg=NONE gui=NONE cterm=NONE
hi Comment guifg=#636da6 guibg=NONE gui=NONE cterm=NONE
hi Constant guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#c53b53 guibg=NONE gui=NONE cterm=NONE
hi Identifier guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#222436 guibg=#ffc777 gui=NONE cterm=NONE
hi Type guifg=#c8d3f5 guibg=NONE gui=NONE cterm=NONE
hi Underlined guifg=#c8d3f5 guibg=NONE gui=underline cterm=underline
...
if s:t_Co >= 256
  ...
  hi Directory ctermfg=189 ctermbg=NONE cterm=NONE
  ...
  hi Folded ctermfg=60 ctermbg=235 cterm=NONE
  ...
  hi WarningMsg ctermfg=103 ctermbg=NONE cterm=NONE
  hi WildMenu ctermfg=222 ctermbg=NONE cterm=NONE
  hi Comment ctermfg=60 ctermbg=NONE cterm=NONE
  hi Constant ctermfg=189 ctermbg=NONE cterm=NONE
  hi Error ctermfg=161 ctermbg=NONE cterm=NONE
  hi Identifier ctermfg=189 ctermbg=NONE cterm=NONE
  hi Ignore ctermfg=189 ctermbg=NONE cterm=NONE
  hi PreProc ctermfg=189 ctermbg=NONE cterm=NONE
  hi Special ctermfg=189 ctermbg=NONE cterm=NONE
  hi Statement ctermfg=189 ctermbg=NONE cterm=NONE
  hi Todo ctermfg=235 ctermbg=222 cterm=NONE
  hi Type ctermfg=189 ctermbg=NONE cterm=NONE
  hi Underlined ctermfg=189 ctermbg=NONE cterm=underline
